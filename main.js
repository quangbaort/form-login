...
function show_login() {
    $('#middle-contain').css('display', 'block').html(`
				<center id="login_box" style="display:none;">
					<input id='username' placeholder='Username' autocomplete="off" class='form-control' type='username' style='font-size: 16px;color: #4DABFF;border: 1px solid #5988B2;background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAYdEVYdFNvZnR3YXJlAHBhaW50Lm5ldCA0LjAuOWwzfk4AAAATSURBVBhXY2DgFtuFgakuKLYLAEeqFWTdWGbFAAAAAElFTkSuQmCC");'><br>
    ...
    $('#login-button').html(`
				<center style="display:block;">
					<button id="submit_login" class="btn btn-primary" style="margin-left: -62px;">HiBlue Sign in</button>
				</center>
			`);
